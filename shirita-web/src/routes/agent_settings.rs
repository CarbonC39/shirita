...
use shirita_core::agent::{
    ...
    MAX_MATH_PARSE_DEPTH, MAX_RANDOM_INTEGER_SPAN, MAX_RANDOM_ITEMS, MAX_STATUS_MESSAGE_BYTES,
    MAX_TOOL_ARGUMENT_BYTES, MAX_TOOL_RESULT_BYTES, MAX_XML_ROUND_BYTES,
};
