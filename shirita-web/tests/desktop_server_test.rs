...
async fn test_state() -> AppState {
    ...
    AppState {
        ...
        token_counter,
        model: "m".into(),
        generations: Arc::new(Generations::new()), http_client: shirita_web::new_http_client(), authorization: Arc::new(shirita_core::mcp::authorization::AuthorizationBroker::new()),
    }
}
