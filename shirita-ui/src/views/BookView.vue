...
<template>
  <div class="pt-6 pb-12">
    ...
    <template v-else>
      ...
      <input :ref="(el) => { impex.importInput.value = el as HTMLInputElement }" type="file" hidden accept=".json,application/json,.zip,application/zip" @change="impex.onImportPicked" />
