...
const en = {
  ...
  book: {
    ...
    onConflict: 'When an imported item has the same name + type as an existing one: Skip = keep the existing one, drop the import. Overwrite = replace the existing one with the imported content. Duplicate = always import as a new, separate item.',
    conflictSkip: 'Skip',
