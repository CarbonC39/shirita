...
const zhHans: MessageSchema = {
  ...
  definition: {
    ...
    messageTypeHint: '会话开始时的开场白；其他备选作为滑动卡片。',
  },
  variables: {
    heading: '变量',
    system: '系统',
  ...
  settings: {
    ...
    nativeTools: 'Provider 支持原生 Tool calling',
    nativeToolsSupported: '支持',
    nativeToolsUnsupported: '不支持',
    agent: 'RP Agent 框架',
    agentEnabled: '启用 Agent 循环',
    agentTransport: 'Tool 传输方式',
    agentTransportAuto: '自动',
    agentTransportNative: '原生',
    agentTransportXml: 'XML 后备',
    agentRounds: '最大轮数',
    agentToolCalls: '最大 Tool 调用数',
    agentTimeout: 'Tool 超时（毫秒）',
    agentRepetition: '重复调用轮数',
    agentActivity: '显示运行活动',
    agentUserStatus: '显示用户可见状态',
    agentTools: '能力 Tools',
    agentSystemPrompt: '框架系统提示词',
    agentUnfinishedPrompt: '未完成时继续提示词',
    agentReset: '恢复默认',
    agentSessionOverride: '为此对话单独设置',
    agentInherited: '正在使用全局 Agent 设置。',
    testing: '测试中…',
    testConnection: '测试连接',
    generation: '生成',
    temperature: '温度',
    ...
    addRule: '+ 添加规则',
    about: '关于',
    aboutText: 'Shirita —— 一个由用户掌控、可组合的 AI 角色扮演平台。',
    regexUnnamed: '未命名规则',
